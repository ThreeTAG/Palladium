...
import net.threetag.palladium.core.entity.fabric.PlayerNameChangeImpl;
...
@Mixin(Player.class)
public abstract class PlayerMixin implements PlayerNameChangeImpl.RefreshableDisplayName {
