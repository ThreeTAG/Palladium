...
public class PalladiumComponents implements EntityComponentInitializer {
    ...
    public static final ComponentKey<AccessoriesComponent> ACCESSORIES =
            ComponentRegistryV3.INSTANCE.getOrCreate(new ResourceLocation(Palladium.MOD_ID, "accessories"), AccessoriesComponent.class);
    ...
    public void registerEntityComponentFactories(EntityComponentFactoryRegistry registry) {
        ...
        registry.registerForPlayers(ACCESSORIES, AccessoriesComponent::new, RespawnCopyStrategy.CHARACTER);
    }
