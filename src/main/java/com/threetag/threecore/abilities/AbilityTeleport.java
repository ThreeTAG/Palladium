...
public class AbilityTeleport extends Ability
{
	...
	public static final ThreeData<Float> DISTANCE = new ThreeDataFloat("distance").setSyncType(EnumSync.NONE)
	...
	@Override public void updateTick(EntityLivingBase entity)
	{
		...
		if (rtr != null && rtr.hitVec != null)
		{
			...
			for (int i = 0; i < 30; ++i)
			{
				PlayerHelper.spawnParticleForAll(
						...
						(float) entity.posY + entity.world.rand.nextFloat() * entity.height, (float) entity.posZ, (
