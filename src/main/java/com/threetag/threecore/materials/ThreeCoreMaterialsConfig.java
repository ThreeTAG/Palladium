...
public class ThreeCoreMaterialsConfig {

    public static ThreeCoreMaterialsConfig INSTANCE;

    public static ForgeConfigSpec generateConfig() {
        ForgeConfigSpec.Builder builder = new ForgeConfigSpec.Builder();
        INSTANCE = new ThreeCoreMaterialsConfig(builder);
    ...
    private ThreeCoreMaterialsConfig(ForgeConfigSpec.Builder builder) {
