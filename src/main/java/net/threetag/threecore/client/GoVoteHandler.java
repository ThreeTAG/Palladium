package net.threetag.threecore.client;
 ...
 */
@EventBusSubscriber(modid = ThreeCore.MODID, bus = EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
public class GoVoteHandler {

    private static final String BRAND = "ThreeTAG";
    ...
    public static void init(FMLClientSetupEvent event) {
        ...
        try {
            ...
            if (ex instanceof FileAlreadyExistsException) {
                ThreeCore.LOGGER.debug("Go vote handler: Marker already exists");
            }
