...
public class ShovelAbilityItem extends ShovelItem implements IAbilityProvider {
    ...
    public ShovelAbilityItem setAbilities(List<Supplier<Ability>> abilities) {
        this.abilityGenerators = abilities;
        return this;
    }

    public ShovelAbilityItem addAbility(Supplier<Ability> abilityGenerator) {
    ...
    public ShovelAbilityItem setDescription(List<ITextComponent> description) {
        DistExecutor.runWhenOn(Dist.CLIENT, () -> () -> this.description = description);
        return this;
    }

    public ShovelAbilityItem addDescriptionLine(ITextComponent line) {
