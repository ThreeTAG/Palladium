    ...
    public <T> void set(ThreeData<T> data, T value) {
        ...
        if (entry != null && !entry.getValue().equals(value)) {
            ...
            if (this.dataHolder instanceof Ability && ((Ability) this.dataHolder).entity != null) {
                ((Ability) this.dataHolder).getEventManager().fireEvent("ability_data_changed", new LivingEntityAccessor(((Ability) this.dataHolder).entity), new AbilityAccessor((Ability) this.dataHolder), data.key, oldValue, value);
