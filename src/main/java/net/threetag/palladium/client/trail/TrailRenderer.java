...
public abstract class TrailRenderer<T> {
    ...
    public abstract void submit(PoseStack poseStack, SubmitNodeCollector submitNodeCollector, LivingEntityRenderState ownerRenderState, TrailSegment<T> trailSegment, int packedLight, float partialTick);

    public T createData(Entity parent) {
        return null;
    }
