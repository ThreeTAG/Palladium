...
public class RenderableUiComponentWidget extends AbstractWidget {
    ...
    public RenderableUiComponentWidget(RenderableUiComponent component, ScreenRectangle rectangle) {
        super(component.getX(rectangle), component.getY(rectangle), component.getWidth(), component.getHeight(), Component.empty());
