...
public abstract class PackRenderLayer<T extends PackRenderLayer.State> {
    ...
    public abstract void submit(DataContext context, PoseStack poseStack, SubmitNodeCollector submitNodeCollector, EntityModel<LivingEntityRenderState> parentModel, LivingEntityRenderState entityState, T layerState, int packedLight, float partialTick, float xRot, float yRot);

    public abstract void submitArm(DataContext context, PoseStack poseStack, SubmitNodeCollector submitNodeCollector, HumanoidArm arm, ModelPart armPart, AvatarRenderer<?> playerRenderer, T layerState, int packedLight);
