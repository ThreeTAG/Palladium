...
public class PalladiumUiLayoutProvider extends UiLayoutProvider {
    ...
    protected void gather(HolderLookup.Provider provider) {
        this.unconditional(Power.DEFAULT_POWER_SCREEN, new SimpleUiLayout(
                ...
                196,
                UiPadding.SEVEN,
                new SpriteBackground(ModalScreen.BACKGROUND_MODAL_HEADER),
                Arrays.asList(
                        new PowerNameUiComponent(null, UiComponentProperties.withSize(200, 10)),
                        new PowerTreeUiComponent(null, RepeatingTextureBackground.RED_WOOL, new UiComponentProperties(
