...
public record CustomizationCategory(int sortIndex, PoseStackTransformation preview,
    ...
    public static final Codec<CustomizationCategory> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            PoseStackTransformation.CODEC.optionalFieldOf("preview", DEFAULT_PREVIEW).forGetter(CustomizationCategory::preview),
