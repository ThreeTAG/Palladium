...
public class ConditionSerializers {
    ...
    public static final RegistrySupplier<ConditionSerializer> ABILITY_TICKS_PROPERTY = CONDITION_SERIALIZERS.register("ability_ticks_property", AbilityTicksCondition.Serializer::new);
