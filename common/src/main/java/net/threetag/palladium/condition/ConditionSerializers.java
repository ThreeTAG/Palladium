...
public class ConditionSerializers {
    ...
    public static final RegistrySupplier<ConditionSerializer> ABILITY_WHEEL = CONDITION_SERIALIZERS.register("ability_wheel", AbilityWheelCondition.Serializer::new);
