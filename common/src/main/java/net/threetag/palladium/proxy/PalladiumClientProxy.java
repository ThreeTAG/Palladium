...
public class PalladiumClientProxy extends PalladiumProxy {
    ...
    @Override
    public boolean playerHasSlimModel(Player player) {
    ...
    @Override
    public void packetHandleOpenAbilityBuyScreen(OpenAbilityBuyScreenPacket packet, NetworkManager.PacketContext context) {
    ...
    @Override
    public void packetHandleSyncAbilityComponent(SyncAbilityComponentPacket packet, NetworkManager.PacketContext context) {
    ...
    @Override
    public void packetHandleSyncEntityCustomization(SyncEntityCustomizationPacket packet, NetworkManager.PacketContext context) {
        Level level = Minecraft.getInstance().level;
        if (level != null && level.getEntity(packet.entityId()) instanceof LivingEntity livingEntity) {
    ...
    @Override
    public void packetHandleSyncEntityCustomizations(SyncEntityCustomizationsPacket packet, NetworkManager.PacketContext context) {
        Level level = Minecraft.getInstance().level;
        if (level != null && level.getEntity(packet.entityId()) instanceof LivingEntity livingEntity) {
            var handler = EntityCustomizationHandler.get(livingEntity);
    ...
    @Override
    public void packetHandleSyncEntityUnselectCustomization(SyncEntityUnselectCustomizationPacket packet, NetworkManager.PacketContext context) {
        Level level = Minecraft.getInstance().level;
        if (level != null && level.getEntity(packet.entityId()) instanceof LivingEntity livingEntity) {
            var handler = EntityCustomizationHandler.get(livingEntity);
    ...
    @Override
    public void packetHandleSyncEntityPowers(SyncEntityPowersPacket packet, NetworkManager.PacketContext context) {
        Level level = Minecraft.getInstance().level;
