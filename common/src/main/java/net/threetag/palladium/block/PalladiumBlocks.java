...
public class PalladiumBlocks {
    ...
    public static final RegistrySupplier<Block> LEAD_ORE = BLOCKS.register("lead_ore", () -> new DropExperienceBlock(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(3.0F, 3.0F)));
    public static final RegistrySupplier<Block> DEEPSLATE_LEAD_ORE = BLOCKS.register("deepslate_lead_ore", () -> new DropExperienceBlock(BlockBehaviour.Properties.copy(LEAD_ORE.get()).mapColor(MapColor.DEEPSLATE).strength(4.5F, 3.0F).sound(SoundType.DEEPSLATE)));
    ...
    public static final RegistrySupplier<Block> REDSTONE_FLUX_CRYSTAL_CLUSTER = BLOCKS.register("redstone_flux_crystal_cluster", () -> new RedstoneFluxCrystalClusterBlock(7, 3, BlockBehaviour.Properties.copy(Blocks.AMETHYST_CLUSTER).mapColor(MapColor.COLOR_RED)));
    public static final RegistrySupplier<Block> LARGE_REDSTONE_FLUX_CRYSTAL_BUD = BLOCKS.register("large_redstone_flux_crystal_bud", () -> new RedstoneFluxCrystalClusterBlock(5, 3, BlockBehaviour.Properties.copy(Blocks.LARGE_AMETHYST_BUD).mapColor(MapColor.COLOR_RED)));
    public static final RegistrySupplier<Block> MEDIUM_REDSTONE_FLUX_CRYSTAL_BUD = BLOCKS.register("medium_redstone_flux_crystal_bud", () -> new RedstoneFluxCrystalClusterBlock(4, 3, BlockBehaviour.Properties.copy(Blocks.MEDIUM_AMETHYST_BUD).mapColor(MapColor.COLOR_RED)));
    ...
    public static final RegistrySupplier<Block> SOLAR_PANEL = BLOCKS.register("solar_panel", () -> new SolarPanelBlock(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(5.0F, 6.0F)));
