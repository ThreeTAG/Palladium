...
public class AbilityWheelRenderer implements OverlayRegistry.IngameOverlay {
    ...
    public static void setWheel(List<AbilityInstance> abilities) {
        CURRENT_WHEEL = abilities != null ? new Wheel(abilities) : null;
    }
    ...
    public static final class Wheel {
        ...
        public Wheel(List<AbilityInstance> abilities) {
