...
public class AbilityWheelHoveredVariable extends AbstractBooleanTextureVariable {
    ...
    public boolean getBoolean(DataContext context) {
        return context.has(DataContextType.ABILITY_WHEEL_HOVERED) && context.get(DataContextType.ABILITY_WHEEL_HOVERED);
    }
    ...
    public static class Serializer implements ITextureVariableSerializer {
        ...
        public ITextureVariable parse(JsonObject json) {
            return new AbilityWheelHoveredVariable(
