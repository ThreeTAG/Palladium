...
public class EnergyBeamEffectRenderer implements EntityEffectRenderer<EnergyBeamEffect> {
    ...
    @Override
    public void render(EnergyBeamEffect effect, EffectEntityRenderer.EffectEntityRenderState renderState, Entity anchor, PoseStack poseStack, MultiBufferSource bufferSource, int packedLightIn, boolean isFirstPerson, float partialTicks) {
