...
public class AddonPackLogEntryScreen extends Screen {
    ...
    protected void init() {
        ...
        this.addRenderableWidget(new Button(this.width / 2 - 50, this.height - 64 + 32 - 10, 250, 20, new TranslatableComponent("gui.palladium.addon_pack_log_entry.upload_to_mclogs"), (button) -> {
            try {
