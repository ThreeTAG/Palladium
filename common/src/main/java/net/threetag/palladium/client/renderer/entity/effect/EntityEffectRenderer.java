...
public interface EntityEffectRenderer<T extends EntityEffect> {
    ...
    static <T extends EntityEffect> void renderEffect(T effect, EffectEntityRenderer.EffectEntityRenderState renderState, Entity anchor, PoseStack poseStack, MultiBufferSource bufferSource, int packedLightIn, boolean isFirstPerson, float partialTicks) {
        getRenderer(effect).render(effect, renderState, anchor, poseStack, bufferSource, packedLightIn, isFirstPerson, partialTicks);
    }

    void render(T effect, EffectEntityRenderer.EffectEntityRenderState renderState, Entity anchor, PoseStack poseStack, MultiBufferSource bufferSource, int packedLightIn, boolean isFirstPerson, float partialTicks);
