...
public abstract class FloatValue extends Value {
    ...
    protected static <B extends FloatValue> RecordCodecBuilder<B, String> modifyFunctionCodec() {
        return Codec.STRING.optionalFieldOf("modify", "").forGetter(v -> v.molang);
    }

    public static abstract class FloatSerializer<T extends FloatValue> extends ValueSerializer<T> {
